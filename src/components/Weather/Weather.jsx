...
export default function Weather(props) {
  ...
  useEffect(() => {
    city &&
      fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=14cb5b00d527cf8f7bcb66f6516bca11`
      )
        .then((res) => res.json())
        .then((data) => {
          setMainInfo(data);
                ...
                <div className="md:text-left text-center">
                  ...
                  <p className="">
                    ...
                    <span className="text-yellow-400 font-bold lg:text-5xl text-3xl w-full inline-block m-3">
                      {Number(mainInfo.main.temp - 272).toFixed()} °c
                    </span>
                    <span className="text-white text-xl pl-3">
                      {mainInfo.weather[0].main}
                    </span>
                  </p>
                </div>
